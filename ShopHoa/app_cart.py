...
from ShopHoa.app_admin import admin_brands, admin_addcat
import secrets,os
import json
...
def getCart():
    ...
    return render_template('cart.html',tax=tax, grandtotal=grandtotal,brands=admin_brands(),categories=admin_addcat())
